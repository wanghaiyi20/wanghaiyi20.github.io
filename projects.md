...
## Quasi-Delay-Insensitive Asynchronous Circuit Logic Synthesis Tool for SiC Process
...
- Built virtual cell library mapping support for asynchronous primitives and gate-level realization.
- Supported later-stage ASIC logic synthesis and verification workflows.

---

## Fully Asynchronous Superscalar RISC-V Processor / SoC
...
- Participated in ASIC flow tasks including logic synthesis, functional debugging, static timing analysis, dynamic timing verification, parasitic extraction, and physical verification.
- Gained practical full-flow experience from architecture design to backend validation.

---

## RISC-V Matrix Computing SoC / TPU Matrix Acceleration Subsystem
...
- Contributed to a commercially deliverable FPGA development board for AI acceleration computing.

---

## 40nm Fully Asynchronous Many-Core 8051 CPU Interconnection Chip Based on BBD Protocol
...
- Accumulated experience in chip bring-up, board-level debugging, and laboratory hardware testing.
